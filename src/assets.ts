...
export const assets = {
  ...
  img_blueTeamBadge: new ex.ImageSource('sprites/team_badges/blue_team_badge.png'),
  img_redTeamBadge: new ex.ImageSource('sprites/team_badges/red_team_badge.png'),
  ...
  ase_scoreNumbers: new AsepriteResource('sprites/score_numbers/score_numbers.json'),
